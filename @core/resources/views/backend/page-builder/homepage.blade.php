    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <div class="form-check form-switch row">
                                        ...
                                        <input {{ $default_home_page == "on" ? "checked" : "" }} value="on" class="form-check-input col-md-6 ml-0" name="default_home_page" type="checkbox" role="switch" id="homePageSwitch">
                                    </div>
                                </div>
                            </div>

                            <div class="row page-select-division" style="display:{{ $default_home_page == "on" ? "flex" : "none" }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control form-control-sm" name="reading_page" id="page-selector">
                                        ...
                                        @foreach($pages as $item)
                                            <option {{ $selected_home_page == $item->id ? "selected" : "" }} value="{{ $item->id }}">{{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="card default-home-page-style-wrapper" style="{{ $default_home_page == "on" ? "display:none" : "display:block" }}">
                    <div class="card-body">
