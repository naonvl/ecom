                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            <h4 class="header-title">{{__('Edit Category Menu')}}</h4>
                            <div class="btn-wrapper">
                                <a href="{{route('admin.category.menu.settings')}}" class="btn btn-primary btn-xs">{{__('All Category Menus')}}</a>
                            </div>
                        </div>
                        <form action="{{route('admin.category.menu.update',$page_post->id)}}" id="menu_update_form" method="post"
