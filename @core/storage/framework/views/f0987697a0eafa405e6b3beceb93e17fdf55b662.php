                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="fixe_date_container" style="display: none">
                                        ...
                                        <p class="text-secondary mb-4"><?php echo e(__('This will change all the start and end date to selected date.')); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-9">
                                                    ...
                                                    <div class="card border-primary mb-3" style="border: 1px solid">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="campaign_subtitle" name="campaign_subtitle" placeholder="Campaign Subtitle" value="<?php echo e($campaign->subtitle); ?>">
                                                            </div>
                                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                                            ...
                                                            <div class="card border-primary mb-3" style="border: 1px solid">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                <label for="units_for_sale"><?php echo e(__('Original Price')); ?></label>
                                                                                <input type="number" class="form-control original_price product_original_price" disabled value="<?php echo e(optional($campaign_product->product)->sale_price); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                <label for="campaign_price"><?php echo e(__('Price for Campaign')); ?></label>
                                                                                <input type="number" name="campaign_price[]" class="form-control campaign_price" value="<?php echo e($campaign_product->campaign_price); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number" name="units_for_sale[]" id="units_for_sale" class="form-control" value="<?php echo e($campaign_product->units_for_sale); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-row">
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="start_date[]" class="form-control start_date flatpickr" value="<?php echo e($campaign_product->start_date); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                <label for="end_date"><?php echo e(__('End Date')); ?></label>
                                                                                <input type="text" name="end_date[]" class="form-control end_date flatpickr" value="<?php echo e($campaign_product->end_date); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/backend/campaign/edit.blade.php ENDPATH**/ ?>