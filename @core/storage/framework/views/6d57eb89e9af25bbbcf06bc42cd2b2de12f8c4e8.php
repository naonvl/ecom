                    ...
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <div class="btn-wrapper">
                                ...
                                <a class="btn btn-lg btn-info btn-sm mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.dynamic.page', ['slug' => $page->slug, 'id' => $page->id])); ?>">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/backend/page-builder/dynamicpage.blade.php ENDPATH**/ ?>