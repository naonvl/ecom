                        ...
                        <form action="<?php echo e(route('admin.shipping.method.update')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group" <?php if(in_array(optional($item->options)->setting_preset, ['none', 'valid_coupon'])): ?> style="display: none" <?php endif; ?>>
                                        <label for="minimum_order_amount"><?php echo e(__('Minimum Order Amount')); ?></label>
                                        <input type="number" id="minimum_order_amount" name="minimum_order_amount" class="form-control" step="0.01" placeholder="<?php echo e(__('Minimum Order Amount')); ?>" value="<?php echo e(optional($item->options)->minimum_order_amount); ?>">
                                    </div>
                                    <div class="form-group" <?php if(in_array(optional($item->options)->setting_preset, ['none', 'valid_coupon', 'min_order'])): ?> style="display: none" <?php endif; ?>>
                                        <label for="coupon"><?php echo e(__('Coupon')); ?></label>
                                        <input type="text" id="coupon" name="coupon" class="form-control" value="<?php echo e(optional($item->options)->coupon); ?>" placeholder="<?php echo e(__('Enter coupon name')); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="cost" name="cost" class="form-control" placeholder="<?php echo e(__('Cost')); ?>" step="0.01" value="<?php echo e(optional($item->options)->cost); ?>">
                                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/backend/shipping/method/edit.blade.php ENDPATH**/ ?>