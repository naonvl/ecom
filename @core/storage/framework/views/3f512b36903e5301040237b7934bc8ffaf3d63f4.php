                                        ...
                                        <div id="accordion-payment">
                                            <div class="card">
                                                ...
                                                <div id="paypal_settings_content" class="collapse show"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="paypal_payment_action"><?php echo e(__('Paypal Payment Action')); ?></label>
                                                            <input type="text" name="paypal_payment_action"
                                                                   class="form-control"
                                                                   value="<?php echo e(get_static_option('paypal_payment_action')); ?>">
                                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="bank_payment_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                ...
                                                                aria-expanded="false">
                                                            <span class="page-title"> <?php echo e(__('Bank Payment Settings')); ?></span>
                                                        </button>
                                                    </h5>
                                                </div>
                                                <div id="bank_payment_settings_content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="bank_payment_gateway"><strong><?php echo e(__('Enable/Disable Bank Payment')); ?></strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="bank_payment_gateway"
                                                                       <?php if(!empty(get_static_option('bank_payment_gateway'))): ?> checked
                                                                       <?php endif; ?> id="bank_payment_gateway">
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_logo"><strong><?php echo e(__('Bank Payment Logo')); ?></strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    <?php
                                                                ...
                                                                <input type="hidden" id="bank_payment_preview_logo"
                                                                       ...
                                                                       value="<?php echo e(get_static_option('bank_payment_preview_logo')); ?>">
                                                                <button type="button"
                                                                        class="btn btn-info media_upload_form_btn"
                                                                        data-btntitle="<?php echo e(__('Select Image')); ?>"
                                                                        data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="site_bank_payment_name"><?php echo e(__('Bank Payment Name')); ?></label>
                                                            <input type="text" name="site_bank_payment_name"
                                                                   id="site_bank_payment_name"
                                                                   value="<?php echo e(get_static_option('site_bank_payment_name')); ?>"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_bank_payment_description"><?php echo e(__('Bank Payment Description')); ?></label>
                                                            <input type="hidden" name="site_bank_payment_description" value="<?php echo e(get_static_option('site_bank_payment_description')); ?>">
                                                            <div class="summernote" data-content='<?php echo e(get_static_option('site_bank_payment_description')); ?>'></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/backend/general-settings/payment-gateway.blade.php ENDPATH**/ ?>