...
class PageBuilderController extends Controller
{
    ...
    public function homepage_builder()
    {
        ...
        $selected_home_page = get_static_option('home_page_identity');
        $default_home_page = get_static_option('default_home_page');

        return view(self::BASE_PATH . 'homepage',compact('pages','selected_home_page','default_home_page'));
    }
